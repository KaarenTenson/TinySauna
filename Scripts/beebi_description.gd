extends Control
@onready var praegune_hääl = $"../Beebihääl"
...
var beebi_hääled = {"jijitsuBeebi": "res://SFX/jiujitsu_baby.mp3", "KungFuBeebi": "res://SFX/kungfu_baby.mp3", "TaekWonDooBeebi": "res://SFX/taekwondo_baby.mp3", "KarateBeebi": "res://SFX/karate_baby.mp3"}
